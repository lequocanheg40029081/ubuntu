...
<section class="cart__container">
    <div class="container">
        ...
        <div class="payment">
            <div class="box__left">
                <a href="http://localhost:8088/shopping/" class="payment__btn">Tiếp tục mua hàng</a>
            </div>
            <div class="box">
        ...
        <div class="payment">
            <div class="box__left">
                Không có sản phẩm nào ! <a href="http://localhost:8088/shopping/" class="payment__btn">Tiếp tục mua hàng</a>
            </div>
        </div>
        <?php } ?>
    </div>
